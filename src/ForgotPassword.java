...
public class ForgotPassword extends javax.swing.JFrame {
    ...
    void connectDB()
    {
        try
        {
            ...
            con = DriverManager.getConnection("jdbc:sqlite:C:\\Users\\DIVAKAR\\Documents\\Database\\Reg");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        //obje.pw = jPasswordField1.getText();
        connectDB();
        String qry,qry1,pw="";
        try
        {
            qry1 = "SELECT Current from Password";
            stmt = con.createStatement();
            rs = stmt.executeQuery(qry1);
            pw = rs.getString(1);            
            
            if(jPasswordField1.getText().equals(pw))
            {
                qry = "UPDATE Password"+" SET Current = '"+jPasswordField1.getText()+"' WHERE Current ='"+jPasswordField2.getText()+"'";
                stmt = con.createStatement();
                int get;
